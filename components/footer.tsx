            ...
            <footer>
                ...
                <div className={"px-4 mb-12.5  md:px-10 lg:px-25 lg:mb-20 lg:flex lg:items-center lg:justify-between"}>
                    ...
                    <ul className={"mt-3 flex items-center justify-center gap-x-4"}>
                        ...
                        <li className={"w-fit px-4 py-3 bg-white shadow-lg border border-black/20 rounded-xl"}>
                            <Image src={"/images/mastercard.png"} alt={"mastercard"} width={40} height={26}
                                   className={"w-[40px] h-[16px]"}/>
                        </li>
                        <li className={"w-fit px-4 py-3 bg-white shadow-lg border border-black/20 rounded-xl"}>
                            <Image src={"/images/paypal.png"} alt={"paypal"} width={40} height={26}
                                   className={"w-[40px] h-[16px]"}/>
                        </li>
                        <li className={"w-fit px-4 py-3 bg-white shadow-lg border border-black/20 rounded-xl"}>
                            <Image src={"/images/apple-pay.png"} alt={"apple-pay"} width={40} height={26}
                                   className={"w-[40px] h-[16px]"}/>
                        </li>
                        <li className={"w-fit px-4 py-3 bg-white shadow-lg border border-black/20 rounded-xl"}>
                            <Image src={"/images/g-pay.png"} alt={"g-pay"} width={40} height={26}
                                   className={"w-[40px] h-[16px]"}/>
                        </li>
                    </ul>
                </div>
