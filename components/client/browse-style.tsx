    ...
    return (
        <Container>
            <div className={"py-10 px-6 rounded-xl bg-bgSecondary lg:px-16"}>
                <h2
                    className={
                        "px-8 mb-7 text-center text-3xl font-bold font-title mb:mb-10 lg:mb-16"
                    }
                >
                ...
                <div className={"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:gap-4"}>
                    {STYLES.map((item, idx) => (
                        ...
                        >
                            ...
                            <h3
                                className={
                                    "absolute top-4 left-7  z-20 text-2xl font-bold capitalize lg:text-4xl"
                                }
                            >
                                <Link href={`/style/${item.title}`}>{item.title}</Link>
                            </h3>
                        </div>
                    ))}
                </div>
