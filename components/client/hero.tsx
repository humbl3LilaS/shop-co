    ...
    return (
        <section>
            <div className={"md:grid grid-cols-2 md:bg-[#f2f0f1]"}>
                <div
                    className={
                        "py-10 px-4 md:pb-0 md:px-10  lg:px-25 lg:flex flex-col justify-center items-start"
                    }
                >
                    <h2
                        className={
                            "mb-5 text-4xl font-bold uppercase font-title tracking-wide lg:text-[54px] leading-none lg:mb-7"
                        }
                    >
                    ...
                    <Button
                        className={"w-full py-4 mb-5 rounded-2xl font-bold lg:w-[200px] lg:mb-14"}
                    >
                        Shop Now
                    </Button>
                    <div
                        className={
                            "px-6 grid grid-cols-4 grid-rows-2 gap-y-6 lg:grid-cols-6 lg:w-full lg:px-0"
                        }
                    >
                        ...
                        <div
                            className={"pl-4 col-span-2 text-left lg:border-r lg:border-r-black/60"}
                        >
