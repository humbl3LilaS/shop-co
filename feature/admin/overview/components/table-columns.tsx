...
export const columns = [
    columnHelper.accessor("coverImage", {
        header: () => <span></span>,
        cell: ({getValue, row}) => <Image src={getValue()}
    ...
    columnHelper.accessor("price", {
        ...
        cell: ({getValue}) =>
            <span
                className={"block px-3 py-1 rounded-3xl bg-orange-200/50 text-orange-600 text-center font-bold"}>
                ${getValue()}
            </span>
    }),
    columnHelper.accessor("totalEarning", {
        ...
        cell: ({getValue}) =>
            <span
                className={"block px-3 py-1 rounded-3xl bg-blue-200/50 text-blue-600 text-center font-bold"}>
                ${getValue()}
            </span>
    }),
